...
```
```json title="Example.blueprint.json" 
{
  "type": "CORE:Blueprint",
  "name": "Example",
  "description": "",
...
```json title="example.entity.json" 
{
  "type": "./Example",
